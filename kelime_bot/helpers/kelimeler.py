import random
kelimeler = ["gözəl","məlumat","problem","təmin etmək","ayrılmaq","vaxt","su","istifadə ediləcək","deyil","bax",
...
'bir', 'və', 'olmaq', 'bu', 'üçün', 'o', 'mən', 'demək', 'çox', 'edmək', 'nə', 'bəyənmək', ' daha çox ', 'almaq',
             ...
             'şəxs', 'onlar', 'və ya', 'birinci', 'görə', 'ön', 'son', 'bir', 'forma', 'vacib', 'üz', 'hər ikisi', ' göstərmək ', 'etmək','qalx', 'hətta', 'təsir', 'inkişaf etmək', 'keçmək', 'bədən', 'düşüncə', 'milyon', 'oynamaq', 'dəyişiklik', 'əsas',
...
'daimi', 'sağlamlıq', 'müxtəlif', 'bundan', 'hiss', 'halbuki', 'səhər', 'internet', 'texniki', 'çıxış',
             ...
             'mal', 'saç', 'itirmək', 'qalıq', 'dəyişiklik', 'dörd', 'həqiqətən', 'səhifə', 'texnologiya', 'qurum', 'beş','ağlama', 'əlaqəli', 'konsept', 'artım', 'fəaliyyət', 'zərər', 'dərin', 'lounge', 'bir növ', 'kəsilmiş',
