...
async def passs(c:Client, m:Message):
    ...
    if aktif:
        if oyun[m.chat.id]["pass"] < 3:
            ...
            await c.send_message(m.chat.id,f"🏷️ 𝖳𝗈𝗉𝗅𝖺𝗆 3 𝗉𝖺𝗌𝗌 𝗁𝖺𝗄𝗄𝗂𝗇𝗂𝗓 𝗏𝖺𝗋𝖽𝗂𝗋 !\n🥳 𝖪𝖾𝗅𝗂𝗆𝖾 𝖯𝖺𝗌 𝖦𝖾𝖼𝗂𝗅𝖽𝗂 !\n✏️ 𝖤𝗌𝗄𝗂 𝖪𝖾𝗅𝗂𝗆𝖾 : **<code>{oyun[m.chat.id]['kelime']}</code>**")
...
✏️ 𝖪𝖺𝗋𝗂𝗌𝗂𝗄 𝖧𝖺𝗋𝖿𝗅𝖾𝗋𝖽𝖾𝗇 𝖣𝗈𝗀𝗋𝗎 𝖪𝖾𝗅𝗂𝗆𝖾𝗒𝗂 𝖡𝗎𝗅𝗎𝗇 🥳 🥳 🥳
            ...
            await c.send_message(m.chat.id, f"<code>🏷️ 𝖴𝗓𝗀𝗎𝗇𝗎𝗆 𝖯𝖺𝗌𝗌 𝖧𝖺𝗄𝗄𝗂𝗇 𝖡𝗂𝗍𝗆𝗂𝗌 ! </code>\n• 𝖮𝗒𝗎𝗇𝗎 𝖻𝗂𝗍𝗂𝗋𝗆𝖾𝗄 𝗂𝖼𝗂𝗇 /stop 𝗒𝖺𝗓𝖺𝖻𝗂𝗅𝗂𝗋𝗌𝗂𝗇 . . .")
    else:
        await m.reply(f"🏷️ 𝖦𝗋𝗎𝖻𝗍𝖺 𝗌𝗎 𝖺𝗇𝖽𝖺 𝖺𝗄𝗍𝗂𝖿 𝖻𝗂𝗋 𝗈𝗒𝗎𝗇 𝗒𝗈𝗄 !\n• 𝖸𝖾𝗇𝗂 𝗈𝗒𝗎𝗇 𝖻𝖺𝗌𝗅𝖺𝗍𝗆𝖺𝗄 𝗂𝖼𝗂𝗇 /game 𝗒𝖺𝗓𝖺𝖻𝗂𝗅𝗂𝗋𝗌𝗂𝗇𝗂𝗓 . . .")
