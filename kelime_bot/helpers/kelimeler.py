import random
kelimeler = ["gözəl ","məlumat ","problem","təmin ","Tərk","vaxt","su","eləmək","istifadə","yox","görmək",
             "dərinizdən", "çoxu", "Amma", "manat", "oynamaq", "gül", "şəhər", "yüksəlmək", "mübarizə", "dalaşmaq", "gəncə",
             "elnur", "gərək", "müalicə", "pul", "rahat", "soyuq", "orası", "kitab", "paylaşmaq", "hesab", "bədən",
             "torpaq", "aslan", "sistem", "xoş", "çəkilmək", "texniki", "yaxın", "il", "tarix", "qoyin", "bacı",
             "ince", "eğer", "oysa", "karşılık","vermək", "sahib", "izafi", "kişi", "digər", "sora", "yenə", "bunlar",
             "kitab", "hadisə", "var", "siz", "devlət", "arxa", "ənçox", "baxmaq", "üstünə", "belə", "bəzi", "başlamaq",
             "tutmak", "birbiri", "heçbir", "eləməm", "su", "kimi", "hal", "doğru", "orta", "başka", "büyük", "etmek",
